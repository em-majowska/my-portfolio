...
import { isDesktop, touch, showMenu, initNavToggle, initAnimationObserver, scrollToTop, initSpotlightCursor, spotlight, fetchGalleryData } from './utils.js';
...
function initCardModuleObserver() {
  jsModuleObserver = new IntersectionObserver(async entries => {
