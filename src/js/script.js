...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // Card 10 demo
  initCard10(document.querySelector(`[data-module='card-10'`));
});

/* SVG paths for mobile and desktop */
...
function updateHero() {
  ...
  const selectedPaths = isWide ? paths.desktop : paths.mobile;
  outline.setAttribute('viewBox', isWide ? '0 0 616 669' : '0 0 368 390');

  Array.from(outline.children).forEach((line, i) => {
